      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{
          ...
          <button 
            ...
            style={{
              padding: '14px',
              background: 'linear-gradient(135deg, #ffc550, #2563eb)',
              border: 'none',
              borderRadius: '10px',
              color: 'white',
              fontSize: '16px',
            ...
            onMouseOut={(e) => e.target.style.opacity = isLoading ? 0.8 : 1}
          >
            {isLoading ? 'Sending...' : 'Send Reset Link'}
          </button>
        </form>
        ...
        <button 
          ...
          onMouseOver={(e) => e.target.color = '#60a5fa'}
          onMouseOut={(e) => e.target.color = '#3b82f6'}
        >
          Back to Login
        </button>
      </div>
